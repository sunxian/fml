...
<form id="frm" method="post" action="${pageContext.request.contextPath}/project/agentCustomers;jsessionid=${pageContext.request.session.id}">
    ...
    <table cellspacing="0" cellpadding="0" id="con_table">
      <tbody>
          ...
          <th scope="col" width="50px;">序号</th>
                <th scope="col" width="100px;">经济人帐号</th>
     ...
     <c:forEach items="${pageBean.list}" var="item" varStatus="st">
        <tr style="background-color: rgb(255, 255, 255);"> 
          ...
          <td width="150px;">${item.agentAccount}</td>

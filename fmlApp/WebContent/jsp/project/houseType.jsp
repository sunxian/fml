    ...
    <table cellspacing="0" cellpadding="0" id="con_table">
      <tbody>
       <tr class="con_table_title">
                    ...
                    <th scope="col" width="150px;">创建时间</th>
                    <th scope="col" width="150px;">更新时间</th>
                    ...
                    <th scope="col" width="50px;">是否主力户型</th>
        ...
        <tr>
          ...
          <td width="100px;">${item.buildingName}</td>     
           <td width="100px;">${item.houseBanName}</td>      
                    ...
                    <th width="250px;">${item.isMainFlag}</th>
                     <th width="250px;">${item.isSalingFlag}</th>                 
                    <th width="250px;"></th>
                   
           <td class="theactions">
          <a href="${pageContext.request.contextPath}/project/updateBuilding" class="common_btn btn_small common_btn_normal2" >编辑</a>
          <a href="${pageContext.request.contextPath}/project/deleteBuilding?id" class="common_btn btn_small common_btn_notice" >删除</a>
          </td>
        </tr>
        </c:forEach>
       </tbody>

...
<div class="left_menu">
    <ul>
     ...
     <li class=""><a href="${pageContext.request.contextPath}/project/houseBan">楼栋管理</a></li>
     <li class=""><a href="${pageContext.request.contextPath}/project/houseType">户型管理</a></li>
     <li class=""><a href="${pageContext.request.contextPath}/project/commission">佣金管理</a></li>
    </ul>
  </div>
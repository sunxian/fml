...
<html>
<head>
<script type="text/javascript" src="../js/common/jquery-1.7.1.js"></script>
...
<body>
    ...
    <form name="userForm1" action="${applicationScope.base}/fileOperate/upload" enctype="multipart/form-data" method="post">
		<div id="newUpload1">
